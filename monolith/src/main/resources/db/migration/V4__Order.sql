...
(
    ...
    created_at      BIGINT    NOT NULL,
    updated_at      BIGINT    NOT NULL,
    PRIMARY KEY (job_vacancy_id, tutor_id)
);
...
insert into job_applications (job_vacancy_id, tutor_id, approval_status, mark_for_delete,
                              created_at, updated_at)
...
insert into job_applications (job_vacancy_id, tutor_id, approval_status, mark_for_delete,
                              created_at, updated_at)
values (2, 4, 'CANCELLED_BY_TUTOR', false, 0, 0);

insert into orders (course_id, tutor_id, student_id, is_active, created_at, updated_at)
